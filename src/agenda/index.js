...
export default class AgendaView extends Component {
    static propTypes = {
        ...
        showCustomHeader: PropTypes.bool,
    };
    ...
    headerHeight() {
        return (this.props.customHeaderHeight ? (this.props.showCustomHeader ? this.props.customHeaderHeight : 0) : 0);
    }
    ...
    render() {
        ...
        const scrollPadPosition = (shouldAllowDragging ? this.headerHeight()  : 0);
        ...
        return (
            <View onLayout={this.onLayout} style={[this.props.style, {flex: 1, overflow: 'hidden', backgroundColor: defaultStyle.backgroundColor}]}>
                <View style={[this.styles.reservations, { marginTop: (this.props.showCustomHeader ? this.props.customHeaderHeight : 0) }]}>
                    {this.renderReservations()}
                </View>
                <Animated.View style={headerStyle}>
                    { this.props.showCustomHeader && this.props.customHeader }
                </Animated.View>
                <Animated.ScrollView
